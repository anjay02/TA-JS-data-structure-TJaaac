...
Object.key(students).length;
// 11. Can you define a key of `let or var` in any object? Reason.
// yeah its possible, because no matter what we define as the key name, ultimately it would get converted into string. 
